...
public class TopicCenterBean {
    ...
    public static class ListBean {
        /**
         * title : 【资讯档】番剧一周资讯Pick Up！
         * cover :
         * link : http://www.bilibili.com/blackboard/activity-rk0PH-M2e.html
         */
